...
HD_PWD='C:/Users/Ray Valenzuela/CPE233/Experiments/Vivado/Experiment 6/Experiment 6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ExpSixTLD.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ExpSixTLD.tcl
