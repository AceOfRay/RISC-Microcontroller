...
HD_PWD='C:/Users/Ray Valenzuela/CPE233/Experiments/Vivado/Experiment 6/Experiment 6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ExpSixTLD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ExpSixTLD.tcl -notrace
